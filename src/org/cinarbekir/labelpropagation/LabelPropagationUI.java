...
public class LabelPropagationUI implements StatisticsUI {
    ...
    private LabelPropagationPanel panel;
    private LabelPropagation labelPropagation;

    public LabelPropagationUI()
    {   
    }
    
    @Override
    public JPanel getSettingsPanel() {
        panel = new LabelPropagationPanel();
        return panel;
    }

    @Override
    public void setup(Statistics ststcs) {
        this.labelPropagation = (LabelPropagation) ststcs;
        if (panel != null) {
            panel.setup((LabelPropagation) ststcs);
        }
    }
